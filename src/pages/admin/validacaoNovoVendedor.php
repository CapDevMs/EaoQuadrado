              ...
              <div class='acordeonFechado'>
                <div class='bloco1'><img src="<?= $base_url; ?>/assets/img/logoEmpresaRica.jpg" class='logoEmpresa'>
                  <div class='blocoTitulo'>
                    ...
                    <div><img src='<?= $base_url; ?>/assets/img/Group.png' style="max-width: 12px; Margin-left:1%;"> Loja 1</div>
                  </div>
                </div>
              ...
              <div class='acordeonAberto'>
                ...
                <div class='acordeonAberto2'>
                  <div class='miniPainel mini1'>
                    <div class = 'internalMini1' style="margin:25px;">

                      <line style="display: flex; justify-content:start;"><span class='redutor' style = 'margin-right:4px;'>Responsável: </span><span class='redutor'> Carlos</span></line>
