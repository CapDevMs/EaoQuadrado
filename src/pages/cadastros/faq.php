...
<body>
    ...
    <main>
        ...
        <div id="texto">Perguntas Frequentes sobre o nosso E-commerce:<br>
            ...
            <h2 class = 'subtitulo'>1 - Como faço para vender no site?</p>
            ...
            <h2 class = 'subtitulo'>2 - Como funciona o processo de compra?</p>
            ...
            <h2 class = 'subtitulo'>3 - Como os vendedores adicionam produtos ao site?</p>
            ...
            <h2 class = 'subtitulo'>4 - Existe um sistema de avaliações para os vendedores?</p>
            ...
            <h2 class = 'subtitulo'>5 - Quais são as opções de entrega disponíveis?</p>
            ...
            <h2 class = 'subtitulo'>6 - Quais métodos de pagamento são aceitos?</p>
            ...
            <h2 class = 'subtitulo'>7 - Como é garantida a segurança das transações?</p>
