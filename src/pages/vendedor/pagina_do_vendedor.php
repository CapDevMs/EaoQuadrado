...
<body>
    ...
    <div class="container">
            <img src="../../assets/img/foto_banner_pagina_vendedor.png" id="foto-banner" alt="foto-banner-vendedor">
            <div class="grid-container-perfil-vendedor">
                <div class="grid-item-perfil-vendedor" id="logo-perfil-vendedor">
                    <div class="container-logo-loja">
                        <img src="../../assets/img/logo_studio_center.png" alt="logo-loja" id="logo-loja" />
                    </div>
                </div>
                ...
                <div class="grid-item-perfil-vendedor">
                    <div class="grid-avaliacao-telefone">
                        ...
                        <img src="../../assets/img/Five star.png" class="grid-avaliacao-telefone" alt="estrela5"
                            id="estrelinha-perfil-vendedor">
                        <img src="../../assets/img/whatsapp-logo.png" id="whatsapp-logo">
            ...
            <div class="container-comentarios">
                <div class="comentario">
                    ...
                    <h1>Alcir Junior</h1>
                    <img src="../../assets/img/Five star.png" class="estrelinha5" alt="estrela5">
