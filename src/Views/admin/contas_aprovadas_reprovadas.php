            ...
            <div class="historico col-sm-9"> 
                <div class="selector col-sm-5">
                    ...
                    <div class="status row">
                        <button class="btn-status filter-button col-sm-3 ativo" id="todos">Todos</button>
                        <button class="btn-status filter-button col-sm-3" id="aprovado">Aprovadas</button>
                        <button class="btn-status filter-button col-sm-3" id="reprovado">Reprovadas</button>
                    </div>
                </div>
