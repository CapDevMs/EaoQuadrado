...
<body>
    ...
    <main>
        ...
        <div class="grid-container">
            ...
            <div class="btn-lista-vendedores">
                <a href="<?=get_base_url();?>admin/listaVendedores">Lista de Vendedores</a>
            </div>
            <div class="btn-novo-vendedor">
                <a href="<?=get_base_url();?>admin/validacaoNovoVendedor">Validar Novo Vendedor</a>
            </div>
        </div>
    </main>
