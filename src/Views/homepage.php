...
<body>
    ...
    <main>
        ...
        <div class="categorias_container">
            <div class="categoria" href="<?= get_base_url(); ?>categoria"><img src="<?= get_base_url(); ?>assets/img/computer_icon.svg" alt="celulares"><p>Eletrônicos</p></div>
            <div class="categoria" href="<?= get_base_url(); ?>categoria"><img src="<?= get_base_url(); ?>assets/img/dress_icon.svg" alt="computer"><p>Moda</p></div>
            <div class="categoria" href="<?= get_base_url(); ?>categoria"><img src="<?= get_base_url(); ?>assets/img/home_icon.svg" alt="smartwatches"><p>Casa</p></div>
            <div class="categoria" href="<?= get_base_url(); ?>categoria"><img src="<?= get_base_url(); ?>assets/img/ball_icon.svg" alt="cameras"><p>Sports</p></div>
            <div class="categoria" href="<?= get_base_url(); ?>categoria"><img src="<?= get_base_url(); ?>assets/img/ring_icon.svg" alt="headphone"><p>Acessorios</p></div>
