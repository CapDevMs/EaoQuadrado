const suporteInfo = ({ nome, descricao, data, status, img_perfil }) => {
  ...
  <div class="accordion col-sm-12" id="${status}">
    <div class="table">
        ...
        <div class="buttons-container">
          <label class="file-container">
              ...
              <span class="file-label">
                <img src="src/public/assets/img/image_icon.png" alt="Ícone de Upload">
                <a>Carregar Imagem</a>
              </span>
          </label>
          ...
          <button class="submit-button" id="submitId">
            <a href="#">
            <img src="src/public/assets/img/send_icon2.png" alt="Ícone de Envio">
            <a>Responder</a>
          </button>
        </a>
      </div>
